...
API reference is generated by Doxygen from headers + the README. Build locally:

```sh
cmake -B build -DMULTI_BUILD_DOCS=ON
cmake --build build --target docs
open build/docs/html/index.html   # macOS; use xdg-open on Linux
```

`master` is auto-published to GitHub Pages via [.github/workflows/docs.yml](.github/workflows/docs.yml) — that's the public URL linked from the README.
